...
namespace Drupal\dropdown\Form; //namespace for dropdown
...
class DropdownForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['district'] = [
      '#type' => 'select',
      '#title' => 'District',
      '#options' => static::getDistricts(),
      '#empty_option' => '- Select -',
      '#required' => TRUE,
      '#prefix' => '<div id="district-dropdown">',
      '#suffix' => '</div>',
    ];
  ...
  public function getStates() {
    ...
    $query->condition('s.country_id', 'IN');
    $result = $query->execute()->fetchAll();
    $options = [];
    foreach ($result as $row) {
